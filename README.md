<!-- Banner -->
<p align="center">
  <img src="./banner.svg" alt="Malak Charty – Ingénieure Informatique MIAGE" width="100%" />
</p>

<!-- Title & subtitle -->
<h1 align="center">Salut, moi c’est <span style="color:#7e57c2">Malak Charty</span> 👋</h1>
<p align="center">
  🎓 Ingénieure en Informatique & Réseaux (MIAGE) • 📍 Casablanca
</p>
...
<p align="center">
  ...
  <a href="https://www.linkedin.com/in/malak-c-174619225"><img src="https://img.shields.io/badge/LinkedIn-malakcharty-673ab7?logo=linkedin&logoColor=white"></a>
</p>
...
**Frameworks & Outils** : Spring Boot, Angular, React, FastAPI, Django, .NET, Flutter, Android Studio  
**Bases de données** : MySQL, SQL Server, Oracle/PLSQL  
**Data & IA** : Machine Learning, Scikit-learn, Pandas, NumPy, Random Forest, Séries temporelles  
**Dev & BI** : Git, Docker, Azure, Azure DevOps, Power BI, API REST, JWT/RBAC
...
### 🚀 Projets à la une
- **PFE – Plateforme intelligente de pilotage prédictif du support IT (Python + FastAPI + React + SQL Server)**  
  Machine Learning, prédiction du volume de tickets, analyse des SLA, détection de surcharge, système de scoring des techniciens et tableaux de bord décisionnels.
